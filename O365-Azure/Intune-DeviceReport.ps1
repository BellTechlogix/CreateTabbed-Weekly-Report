...

{
	...
	if($global:authToken){
		...
		$TokenExpires = ($authToken.ExpiresOn.datetime - $DateTime).Minutes
			...
			write-host
				...
				$user = "kristopher.roy@gti.gt.com"
				Write-Host
	...
	$Devices = $ManagedDevices|select @{N='Name';E={$_.deviceName}},OwnerType,@{N='PrimaryUser';E={$_.UserPrincipalName}},EnrolledDateTime,LastSyncDateTime,@{N='dayssinceSync';E={(new-timespan -start (get-date $_.LastSyncDateTime -Hour "00" -Minute "00") -End (get-date -Hour "00" -Minute "00")).Days}},deviceType,Manufacturer,Model,IMEI,SerialNumber,OperatingSystem,osVersion